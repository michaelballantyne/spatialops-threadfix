...
if( doX )
   ...
   subplot(3,1,1); plot(x,f,'k.',xx,fx,'ro'); legend('orig','interp');
...
if ( doY )
   ...
   subplot(3,1,1);  plot(y,f,'k.',yy,fy,'ro');     legend('orig','interp');
...
if( doZ )
   ...
   subplot(3,1,1);  plot(z,f,'k.',zz,fz,'ro');     legend('orig','interp');
