                    ...
                    const double absError)
{
  ...
  if(IS_GPU_INDEX(f1.device_index())) {
    f1.add_device_sync(CPU_INDEX);
  }
  if(IS_GPU_INDEX(f2.device_index())) {
    f2.add_device_sync(CPU_INDEX);
  }
#endif
