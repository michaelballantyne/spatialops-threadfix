...
namespace FVStaggeredUniform{
  ...
  template<>
  int DefaultSideGhostingX::get<XDIR,SidePlus>(){return 2;}

  template<>
  int DefaultSideGhostingY::get<YDIR,SidePlus>(){return 2;}

  template<>
  int DefaultSideGhostingZ::get<ZDIR,SidePlus>(){return 2;}
