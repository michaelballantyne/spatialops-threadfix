...
int main( int iarg, char* carg[] )
{
  ...
  // build fields
  Field f01( window, NULL );
  Field f01_( window, NULL );
  Field f01__( window, NULL );
  Field f01_3( window, NULL );
  Field f01_4( window, NULL );
  Field f01_5( window, NULL );
  Field f01_6( window, NULL );
  Field f02( window, NULL );
  Field f02_( window, NULL );
  Field f03( window, NULL );
  Field f03_( window, NULL );
  Field f04( window, NULL );
  Field f04_( window, NULL );
  Field f04__( window, NULL );
  Field f04_3( window, NULL );
  Field f05( window, NULL );
  Field f05_( window, NULL );
  Field f06( window, NULL );
  Field f06_( window, NULL );
  Field f07( window, NULL );
  Field f07_( window, NULL );
  Field f07__( window, NULL );
  Field f07_3( window, NULL );
  Field f08( window, NULL );
  Field f08_( window, NULL );
  Field f09( window, NULL );
  Field f09_( window, NULL );
  Field f10( window, NULL );
  Field f10_( window, NULL );
  Field f10__( window, NULL );
  Field f10_3( window, NULL );
  Field f10_4( window, NULL );
  Field f10_5( window, NULL );
  Field f11( window, NULL );
  Field f11_( window, NULL );
  Field f12( window, NULL );
  Field f12_( window, NULL );
  Field f13( window, NULL );
  Field f13_( window, NULL );
  Field f13__( window, NULL );
  Field f13_3( window, NULL );
  Field f14( window, NULL );
  Field f14_( window, NULL );
  Field f15( window, NULL );
  Field f15_( window, NULL );
  Field f16( window, NULL );
  Field f16_( window, NULL );
  Field f16__( window, NULL );
  Field f16_3( window, NULL );
  Field f17( window, NULL );
  Field f17_( window, NULL );
  Field f18( window, NULL );
  Field f18_( window, NULL );
  Field f19( window, NULL );
  Field f19_( window, NULL );
  Field f19__( window, NULL );
  Field f19_3( window, NULL );
  Field f19_4( window, NULL );
  Field f19_5( window, NULL );
  Field f19_6( window, NULL );
  Field f20( window, NULL );
  Field f20_( window, NULL );
  Field f21( window, NULL );
  Field f21_( window, NULL );
  Field f22( window, NULL );
  Field f22_( window, NULL );
  Field f22__( window, NULL );
  Field f22_3( window, NULL );
  Field f23( window, NULL );
  Field f23_( window, NULL );
  Field f24( window, NULL );
  Field f24_( window, NULL );
  Field f25( window, NULL );
  Field f25_( window, NULL );
  Field f25__( window, NULL );
  Field f25_3( window, NULL );
  Field f26( window, NULL );
  Field f26_( window, NULL );
  Field f27( window, NULL );
  Field f27_( window, NULL );
  Field f28( window, NULL );
  Field f28_( window, NULL );
  Field f28__( window, NULL );
  Field f28_3( window, NULL );
  Field f28_4( window, NULL );
  Field f28_5( window, NULL );
  Field f29( window, NULL );
  Field f29_( window, NULL );
  Field f30( window, NULL );
  Field f30_( window, NULL );
  Field f31( window, NULL );
  Field f31_( window, NULL );
  Field f31__( window, NULL );
  Field f31_3( window, NULL );
  Field f32( window, NULL );
  Field f32_( window, NULL );
  Field f33( window, NULL );
