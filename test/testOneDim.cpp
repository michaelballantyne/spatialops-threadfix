...
int main()
{
  ...
  */
  ...
  isFailed |= check_err( 20, 2, 1.0, 3.02584050e-2, 3.17782874e-2, 1.98599559e-1, 7.410158999e-3, 3.170923728e-2, 0.1256835881   );
  isFailed |= check_err( 40, 2, 1.0, 7.59771580e-3, 7.96273079e-3, 4.99407572e-2, 9.352071377e-4, 7.962443016e-3, 0.03177713888  );
  isFailed |= check_err( 80, 2, 1.0, 1.90123684e-3, 1.99181917e-3, 1.25084456e-2, 1.172462558e-4, 1.991801181e-3, 0.007962658853 );
  ...
  isFailed |= check_err( 20, 4, 1.0, 1.360662610e-3, 6.591328897e-3, 1.024802205e-1, 3.328861949e-4, 8.587804659e-4, 0.0088222634 );
  isFailed |= check_err( 40, 4, 1.0, 8.639442669e-5, 4.205666662e-4, 2.517237273e-2, 1.061089627e-5, 5.437630461e-5, 0.0005737300688 );
  isFailed |= check_err( 80, 4, 1.0, 5.420237124e-6, 2.658622206e-5, 6.266903321e-3, 3.342428068e-7, 3.407858931e-6, 3.582233267e-05 );
