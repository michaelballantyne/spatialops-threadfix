...
namespace SpatialOps{
  ...
  // forward declaration.
  namespace FVStaggered{ template<typename T1> class RestrictionAssembler; }
  ...
  struct OpAssemblerSelector< FVStaggered::Restriction, FieldT, FieldT >
  {
    typedef FVStaggered::RestrictionAssembler<FieldT>  Assembler;
  };
  ...
  namespace FVStaggered{
    ...
    public:
      ...
      {
        ghostCols = get_ghost_set<FieldT>( dimSrc_, hasPlusXSideFaces_, hasPlusYSideFaces_, hasPlusZSideFaces_ );
      }
      ...
      {
        ghostRows = get_ghost_set<FieldT>( dimDest_, hasPlusXSideFaces_, hasPlusYSideFaces_, hasPlusZSideFaces_ );
      }
    ...
    get_ncols() const
    {
      return get_n_tot<FieldT>( dimSrc_, hasPlusXSideFaces_, hasPlusYSideFaces_, hasPlusZSideFaces_ );
    }
    ...
    get_nrows() const
    {
      return get_n_tot<FieldT>( dimDest_, hasPlusXSideFaces_, hasPlusYSideFaces_, hasPlusZSideFaces_ );
    }
    ...
    get_row_entries( const int irow,
                     ...
                     std::vector<int> & ixs ) const
    {
      const IndexTriplet ijkDest( flat2ijk<FieldT>::value( dimDest_, irow, hasPlusXSideFaces_, hasPlusYSideFaces_, hasPlusZSideFaces_ ) );
